<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login-Supervisors.aspx.cs" Inherits="_961120026.HTML.Supervisors.Login_Supervisors" %>
...
<head runat="server">
    ...
    <link href="../../Style/Supervisors/Login-Supervisors.css" rel="stylesheet" />
    <script src="../../Java%20Script/Supervisors/Login-Supervisors.js"></script>
    <title></title>
</head>
<body>
                ...
                <div class="contant">
                    <div class="row">
                        ...
                        <div class="col-sm-6 user-pass">
                            <asp:TextBox runat="server" ID="UserTxtboxSupervisors" CssClass="UserPassTxtbox" MaxLength="10" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-3 user-pass">
                        ...
                        <div class="col-sm-6 user-pass">
                            <asp:TextBox runat="server" ID="PassTxtboxSupervisors" CssClass="UserPassTxtbox" TextMode="Password" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 user-pass">
                            <asp:Button Text="ورود" runat="server" ID="loginSupervisorsBTN" OnClick="loginSupervisorsBTN_Click" />
                            <asp:Button Text="بازگشت" runat="server" ID="BCKLoginSupervisors" OnClick="BCKLoginSupervisors_Click"/>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12 user-pass">
