...
{
    public partial class RequestResult_Employees : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("SendRequestResultDetails-Employees.aspx");
        }

        protected void Unnamed1_Click1(object sender, EventArgs e)
        {
            Response.Redirect("SendRequest-Employees.aspx");
        }
    }
}