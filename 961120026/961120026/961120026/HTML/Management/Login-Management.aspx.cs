...
{
    public partial class Login_Management : System.Web.UI.Page
    {
        ...
        protected void loginManagerBTN_Click(object sender, EventArgs e)
        {
            try
            {


                string username = UserTxtboxManager.Text;
                string password = PassTxtboxManager.Text;
                sqlcon.Open();
                SqlCommand cmd = new SqlCommand("SELECT * FROM [Management] WHERE NationalCode = '" + username + "' and Password = '" + password + "'", sqlcon);
                ...
                else if (reader.Read())
                {
                    ...
                    Session["UserIDManagement"] = temp;
                    Session["UserIDManagement2"] = temp2;
        ...
        protected void BCKLoginManagement_Click(object sender, EventArgs e)
        {
